                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:bg-white ${(pathname === '/auth' || pathname.includes('auth')) &&
                          'bg-white  dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
