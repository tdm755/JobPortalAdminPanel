...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#d4e6ff] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="/dashbordsection"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:bg-white ${(pathname === '/' ||
                          pathname.includes('dashbordsection')) &&
              ...
              <li>
                <NavLink
                  to="/candidatedetails"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:bg-white ${pathname.includes('candidatedetails') && 'bg-white  dark:bg-meta-4'
                  }`}
              ...
              <li>
                <NavLink
                  to="/employersdetails"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:bg-white ${pathname.includes('employersdetails') && 'bg-white  dark:bg-meta-4'
                  }`}
                // ${pathname.includes('') &&
                //   'bg-white  dark:bg-meta-4'
                //   }
              ...
              <li>
                <NavLink
                  to="/contactus"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out  hover:bg-graydark hover:bg-white ${pathname.includes('contactus') && 'bg-white  dark:bg-meta-4'
                  }`}
                // ${pathname.includes('') &&
                //   'bg-white  dark:bg-meta-4'
                //   }
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:bg-white ${pathname.includes('chart') && 'bg-white  dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:bg-white ${(pathname === '/ui' || pathname.includes('ui')) &&
                          'bg-white  dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
              ...
              <li>
                <NavLink
                  to="/alerts"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:bg-white ${pathname.includes('alerts') && 'bg-white  dark:bg-meta-4'
                    }`}
                >
                  <svg
              ...
              {/* <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:bg-white ${pathname.includes('profile') && 'bg-white  dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
