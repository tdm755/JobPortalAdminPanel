...
const ResetPassword: React.FC = () => {
   ...
   const handleSubmit = async (e: React.FormEvent) => {
     ...
     try {
       await resetPassword(token!, password); // Use the non-null assertion operator as we assume token exists
      ...
      <div className="flex h-[100vh] w-[90%] flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            ...
            <p className="2xl:px-20">Connecting Talent with Opportunity</p>
